...
HtmlGenerator['label'] = function(block) {
    var statements_content = HtmlGenerator.statementToCode(block, 'content');
    var code = '<label>\n' + statements_content + '</label>\n';
    return code;
};
...
HtmlGenerator['division'] = function(block) {
    ...
    var statements_content = HtmlGenerator.statementToCode(block, 'content');
    var code = '<div  class="mui-input-row"' + value_name + '>\n' + statements_content + '</div>\n';
    return code;
};
...
HtmlGenerator['form'] = function(block) {
    var statements_content = HtmlGenerator.statementToCode(block, 'content');
    var code = '<form  class="mui-input-group">\n' + statements_content + '</form>\n';
    return code;
};
...
HtmlGenerator['input_text123'] = function(block) {
    var text_default = block.getFieldValue('default');
    var code = '<input value="' + text_default + '">\n';
    return code;
};
...
HtmlGenerator['input'] = function(block) {
    ...
    var code = '<input type="' + dropdown_type + '" class="mui-input-clear" placeholder="请输入用户名"  />\n';
    return code;
};
